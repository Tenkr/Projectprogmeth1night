...
public class LogicUtility {
	...
	public static Fighter[] getRandomFighters(int team) {
		...
		for (int i = 0; i < 8; i++) {
			...
			switch (x) {
			case 0:
				randomFighters[i] = new DodgeFighter(GameConstant.MELEE_TYPE_STRING, team);
				break;
			case 1:
			...
			case 4:
				...
				break;
			case 5:
				randomFighters[i] = new DodgeFighter(GameConstant.RANGE_TYPE_STRING, team);
				break;
			case 6:
